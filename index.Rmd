...
>>>>>>> ab44ede436a84acd9a68f2244de99600aad197c6
...
```{r pressure, echo=F,code = readLines("Table Summary.R")}
```

### Chart 1
This chart shows drivng hours during ≤ 8 weeks of gestation in 48 states

```{r echo = F, code = readLines("First Chart.R",)}
```
